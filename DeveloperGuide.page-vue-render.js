...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of students")]),_v(" "),_c('li',[_v("has a need to quickly manage all their lesson plans")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("prefers to view all their students in a centralized platform instead of across separate apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": TutorTrack revolutionizes private tutoring with intuitive keyboard navigation, integrated\ncalendar features, and detailed student profiles. "),_c('br'),_v(" Automated reminders keep tutors organized while robust\nsecurity measures and responsive support ensure a seamless user experience. "),_c('br'),_v(" Experience efficient student management\nwith TutorTrack – the ultimate solution for private tutors.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("view a guide of useful commands")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use TutorTrack")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("add a new student")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("delete an existing")]),_v(" "),_c('td',[_v("remove entries that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("find a student by name")]),_v(" "),_c('td',[_v("locate details of persons without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("view all my students' information")]),_v(" "),_c('td',[_v("view all my students at the same time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("view a specific student's information")]),_v(" "),_c('td',[_v("specifically refer to a particular student's information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("edit student information")]),_v(" "),_c('td',[_v("student information can be edited and changed")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("schedule meeting times with students")]),_v(" "),_c('td',[_v("set lessons")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("delete meeting times with students")]),_v(" "),_c('td',[_v("cancel lessons")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("edit meeting times with students")]),_v(" "),_c('td',[_v("reschedule lessons")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* ")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("view meeting times in a calender view with students")]),_v(" "),_c('td',[_v("track when I have scheduled lessons")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("mark attendance for each week")]),_v(" "),_c('td',[_v("keep an accurate record of student attendance and participation over time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("edit milestones on the progress tracker")]),_v(" "),_c('td',[_v("change milestone plans anytime")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* ")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("add milestones to a progress tracker")]),_v(" "),_c('td',[_v("keep track of topics covered")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("access a summary page with my progress information")]),_v(" "),_c('td',[_v("keep track of my progress")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("view my schedule in a calendar form")]),_v(" "),_c('td',[_v("keep track of lessons for the week/day")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("view a progress tracking meter")]),_v(" "),_c('td',[_v("have a visual representation of a students progress")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* ")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("create account using email")]),_v(" "),_c('td',[_v("have an account that stores all the information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* ")])]),_v(" "),_c('td',[_v("registered user")]),_v(" "),_c('td',[_v("login to my account")]),_v(" "),_c('td',[_v("all the information is tracked and stored properly in the account")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* ")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("upload files and materials")]),_v(" "),_c('td',[_v("students can access to them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("download files and materials")]),_v(" "),_c('td',[_v("review and revise the materials")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("send message to students")]),_v(" "),_c('td',[_v("chat with them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("receive message from tutor")]),_v(" "),_c('td',[_v("be informed with any announcements")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("student")]),_v(" "),_c('td',[_v("receive notification from messages")]),_v(" "),_c('td',[_v("be aware of messages send by tutors")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("freelance tutor")]),_v(" "),_c('td',[_v("note down basic lesson plans (remarks) for each lesson")]),_v(" "),_c('td',[_v("have a structure to follow for each lesson")])]),_v(" "),_c('tr',[_c('td',[_v("plans (remarks) for each lesson")]),_v(" "),_c('td',[_v("have a structure to follow for each lesson")]),_v(" "),_c('td'),_v(" "),_c('td')])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TutorTrack")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Tutor")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"use-case-uc01-add-a-student"}},[_c('strong',[_v("Use case: UC01 Add a student")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc01-add-a-student","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters command to add a specific student in the list")])]),_v(" "),_c('li',[_c('p',[_v("System adds the student")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC02 Delete a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tutor requests to list students")])]),_v(" "),_c('li',[_c('p',[_v("TutorTrack shows a list of students")])]),_v(" "),_c('li',[_c('p',[_v("Tutor requests to delete a specific student in the list")])]),_v(" "),_c('li',[_c('p',[_v("TutorTrack deletes the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 Add a remark to a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a remark to a specific student")])]),_v(" "),_c('li',[_c('p',[_v("TutorTrack adds the remark to the student")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 Find a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("TutorTrack displays a list of students that match the description.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 Schedule a lesson")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a lesson to a student.")])]),_v(" "),_c('li',[_c('p',[_v("TutorTrack displays the lesson in the student information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 Mark a lesson")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests mark a lesson of a student as done.")])]),_v(" "),_c('li',[_c('p',[_v("TutorTrack displays the student information with the lesson removed.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC07 Add a Fee status to a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a fee status to a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("TutorTrack adds the fee status to the student.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 students without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Should be able to hold up to 100 lessons per students without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("Documentation should cover at least 90% of system functionality and architecture.")]),_v(" "),_c('li',[_v("The system should be able to support a minimum of 100 concurrent users without performance degradation.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Freelance Tutor")]),_v(": A tutor that teaches privately, such as a student that teaches on the side")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 23:44:38 GMT+8]")])])])}
}];
